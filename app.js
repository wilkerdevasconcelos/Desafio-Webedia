const app = new Vue({
  ...
  created(){
    // us , ar , ....
    this.carrega('https://newsapi.org/v2/top-headlines?country=br&pageSize=5&apiKey=0dfc1d53c99b4014a2e3f09221edaccd');
    ...
    this.carrega('https://newsapi.org/v2/top-headlines?country=fr&pageSize=5&apiKey=0dfc1d53c99b4014a2e3f09221edaccd');
  }
})